...
/*
    Name: Haobin Alturo Chen Liu
    Student ID: 218294587
    York Login: alturo
 */

public class DemoTiltBall94587Activity extends Activity implements SensorEventListener
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        Log.i(MYDEBUG, "Got here! (DemoTiltBall94587Activity - onCreate)");
        ...
        rb = (RollingBall94587Panel)findViewById(R.id.rollingballpanel);
